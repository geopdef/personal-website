...
# 简历 PDF / 缓存：相对本文件（backend/）所在目录
_BASE_DIR = os.path.dirname(os.path.abspath(__file__))
RESUME_PDF_PATH = os.path.join(_BASE_DIR, 'resume-data-analyst.pdf')
RESUME_CACHE_FILE = os.path.join(_BASE_DIR, 'resume_cache.txt')
RESUME_CACHE_DATE_FILE = os.path.join(_BASE_DIR, 'resume_cache_date.txt')
...
if __name__ == "__main__":
    ...
    print(f"Resume: {'loaded' if RESUME_CONTENT else 'missing'}")
    print(f"Port: {port}")
    print("=" * 60)
